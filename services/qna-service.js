  ...
  getCount: async function(qa_category,keyword){
    try{
      ...
      if(qa_category==="전체" && keyword!==null){   
        ...
        else if((qa_category==="상품문의" || qa_category==="배송문의"|| qa_category==="주문/결제 문의" ) && keyword==null){
          where={
             "qa_category":qa_category
          }
        }else if((qa_category==="답변대기" || qa_category==="답변완료" ) && keyword==null){
          where={
             "qa_status":qa_category
          }
        }else if((qa_category==="배송문의" || qa_category==="주문/결제 문의" || qa_category==="상품문의" ) && keyword!==null){
            where={
              "user_id":{[Op.like]:"%" + keyword + "%"},
              "qa_category":qa_category
            }
